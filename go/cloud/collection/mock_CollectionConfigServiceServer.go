...
func (_m *MockCollectionConfigServiceServer) GetConfigStream(_a0 *GetConfigStreamRequest, _a1 grpc.ServerStreamingServer[GetConfigStreamResponse]) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*GetConfigStreamRequest, grpc.ServerStreamingServer[GetConfigStreamResponse]) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
...
//   - _a1 grpc.ServerStreamingServer[GetConfigStreamResponse]
...
func (_c *MockCollectionConfigServiceServer_GetConfigStream_Call) Run(run func(_a0 *GetConfigStreamRequest, _a1 grpc.ServerStreamingServer[GetConfigStreamResponse])) *MockCollectionConfigServiceServer_GetConfigStream_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*GetConfigStreamRequest), args[1].(grpc.ServerStreamingServer[GetConfigStreamResponse]))
	})
	return _c
}
...
func (_c *MockCollectionConfigServiceServer_GetConfigStream_Call) RunAndReturn(run func(*GetConfigStreamRequest, grpc.ServerStreamingServer[GetConfigStreamResponse]) error) *MockCollectionConfigServiceServer_GetConfigStream_Call {
	_c.Call.Return(run)
	return _c
}

// WaitForProbeConfig provides a mock function with given fields: _a0
func (_m *MockCollectionConfigServiceServer) WaitForProbeConfig(_a0 grpc.BidiStreamingServer[WaitForProbeConfigResponse, WaitForProbeConfigRequest]) error {
	ret := _m.Called(_a0)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(grpc.BidiStreamingServer[WaitForProbeConfigResponse, WaitForProbeConfigRequest]) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
...
//   - _a0 grpc.BidiStreamingServer[WaitForProbeConfigResponse,WaitForProbeConfigRequest]
...
func (_c *MockCollectionConfigServiceServer_WaitForProbeConfig_Call) Run(run func(_a0 grpc.BidiStreamingServer[WaitForProbeConfigResponse, WaitForProbeConfigRequest])) *MockCollectionConfigServiceServer_WaitForProbeConfig_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(grpc.BidiStreamingServer[WaitForProbeConfigResponse, WaitForProbeConfigRequest]))
	})
	return _c
}
...
func (_c *MockCollectionConfigServiceServer_WaitForProbeConfig_Call) RunAndReturn(run func(grpc.BidiStreamingServer[WaitForProbeConfigResponse, WaitForProbeConfigRequest]) error) *MockCollectionConfigServiceServer_WaitForProbeConfig_Call {
	_c.Call.Return(run)
	return _c
}
