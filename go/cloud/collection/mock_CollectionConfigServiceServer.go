...
type mockConstructorTestingTNewMockCollectionConfigServiceServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockCollectionConfigServiceServer(t mockConstructorTestingTNewMockCollectionConfigServiceServer) *MockCollectionConfigServiceServer {
