...
type mockConstructorTestingTnewMockIsProbeResult_Result interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockIsProbeResult_Result(t mockConstructorTestingTnewMockIsProbeResult_Result) *mockIsProbeResult_Result {
