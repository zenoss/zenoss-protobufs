...
// isProbeResult_Result provides a mock function with no fields
...
func (_c *mockIsProbeResult_Result_isProbeResult_Result_Call) RunAndReturn(run func()) *mockIsProbeResult_Result_isProbeResult_Result_Call {
	_c.Run(run)
	return _c
}

// newMockIsProbeResult_Result creates a new instance of mockIsProbeResult_Result. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func newMockIsProbeResult_Result(t interface {
	mock.TestingT
	Cleanup(func())
}) *mockIsProbeResult_Result {
