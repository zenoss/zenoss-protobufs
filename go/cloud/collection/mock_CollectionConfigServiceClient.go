...
func (_m *MockCollectionConfigServiceClient) GetConfigStream(ctx context.Context, in *GetConfigStreamRequest, opts ...grpc.CallOption) (CollectionConfigService_GetConfigStreamClient, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *GetConfigStreamRequest, ...grpc.CallOption) (CollectionConfigService_GetConfigStreamClient, error)); ok {
...
func (_c *MockCollectionConfigServiceClient_GetConfigStream_Call) RunAndReturn(run func(context.Context, *GetConfigStreamRequest, ...grpc.CallOption) (CollectionConfigService_GetConfigStreamClient, error)) *MockCollectionConfigServiceClient_GetConfigStream_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockCollectionConfigServiceClient) WaitForProbeConfig(ctx context.Context, opts ...grpc.CallOption) (CollectionConfigService_WaitForProbeConfigClient, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...grpc.CallOption) (CollectionConfigService_WaitForProbeConfigClient, error)); ok {
		return rf(ctx, opts...)
	}
...
func (_c *MockCollectionConfigServiceClient_WaitForProbeConfig_Call) RunAndReturn(run func(context.Context, ...grpc.CallOption) (CollectionConfigService_WaitForProbeConfigClient, error)) *MockCollectionConfigServiceClient_WaitForProbeConfig_Call {
	_c.Call.Return(run)
	return _c
}
