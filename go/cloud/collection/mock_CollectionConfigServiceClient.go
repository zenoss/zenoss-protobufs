...
type mockConstructorTestingTNewMockCollectionConfigServiceClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockCollectionConfigServiceClient(t mockConstructorTestingTNewMockCollectionConfigServiceClient) *MockCollectionConfigServiceClient {
