...
func (c *collectionConfigServiceClient) WaitForProbeConfig(ctx context.Context, opts ...grpc.CallOption) (CollectionConfigService_WaitForProbeConfigClient, error) {
	stream, err := c.cc.NewStream(ctx, &CollectionConfigService_ServiceDesc.Streams[0], "/zenoss.cloud.collection_cfg.CollectionConfigService/WaitForProbeConfig", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *collectionConfigServiceClient) GetConfigStream(ctx context.Context, in *GetConfigStreamRequest, opts ...grpc.CallOption) (CollectionConfigService_GetConfigStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &CollectionConfigService_ServiceDesc.Streams[1], "/zenoss.cloud.collection_cfg.CollectionConfigService/GetConfigStream", opts...)
	if err != nil {
		return nil, err
	}
