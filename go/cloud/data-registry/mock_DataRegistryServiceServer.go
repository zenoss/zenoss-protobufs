...
type mockConstructorTestingTNewMockDataRegistryServiceServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockDataRegistryServiceServer(t mockConstructorTestingTNewMockDataRegistryServiceServer) *MockDataRegistryServiceServer {
