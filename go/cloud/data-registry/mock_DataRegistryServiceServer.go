...
func (_m *MockDataRegistryServiceServer) CreateOrUpdateMetric(_a0 context.Context, _a1 *RegisterMetricRequest) (*RegisterMetricResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *RegisterMetricRequest) (*RegisterMetricResponse, error)); ok {
		return rf(_a0, _a1)
	}
...
func (_m *MockDataRegistryServiceServer) CreateOrUpdateMetrics(_a0 grpc.ClientStreamingServer[RegisterMetricRequest, RegisterMetricsResponse]) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(grpc.ClientStreamingServer[RegisterMetricRequest, RegisterMetricsResponse]) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockDataRegistryServiceServer_CreateOrUpdateMetrics_Call) Run(run func(_a0 grpc.ClientStreamingServer[RegisterMetricRequest, RegisterMetricsResponse])) *MockDataRegistryServiceServer_CreateOrUpdateMetrics_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(grpc.ClientStreamingServer[RegisterMetricRequest, RegisterMetricsResponse]))
	})
	return _c
}
...
func (_c *MockDataRegistryServiceServer_CreateOrUpdateMetrics_Call) RunAndReturn(run func(grpc.ClientStreamingServer[RegisterMetricRequest, RegisterMetricsResponse]) error) *MockDataRegistryServiceServer_CreateOrUpdateMetrics_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockDataRegistryServiceServer) GetMetric(_a0 context.Context, _a1 *GetMetricRequest) (*GetMetricResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *GetMetricRequest) (*GetMetricResponse, error)); ok {
		return rf(_a0, _a1)
	}
...
func (_m *MockDataRegistryServiceServer) RegisterDefinition(_a0 context.Context, _a1 *Definition) (*DefinitionResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *Definition) (*DefinitionResponse, error)); ok {
		return rf(_a0, _a1)
	}
...
func (_m *MockDataRegistryServiceServer) UpdateDefinition(_a0 context.Context, _a1 *DefinitionUpdate) (*DefinitionResponse, error) {
	...
	var r0 *DefinitionResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *DefinitionUpdate) (*DefinitionResponse, error)); ok {
		return rf(_a0, _a1)
	}
...
func (_m *MockDataRegistryServiceServer) UpdateMetric(_a0 context.Context, _a1 *UpdateMetricRequest) (*RegisterMetricResponse, error) {
	...
	var r0 *RegisterMetricResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *UpdateMetricRequest) (*RegisterMetricResponse, error)); ok {
		return rf(_a0, _a1)
	}
...
func (_m *MockDataRegistryServiceServer) mustEmbedUnimplementedDataRegistryServiceServer() {
	_m.Called()
}
