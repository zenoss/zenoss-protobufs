...
func (_m *MockDataRegistryServiceClient) CreateOrUpdateMetric(ctx context.Context, in *RegisterMetricRequest, opts ...grpc.CallOption) (*RegisterMetricResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *RegisterMetricRequest, ...grpc.CallOption) (*RegisterMetricResponse, error)); ok {
...
func (_m *MockDataRegistryServiceClient) CreateOrUpdateMetrics(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[RegisterMetricRequest, RegisterMetricsResponse], error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...grpc.CallOption) (grpc.ClientStreamingClient[RegisterMetricRequest, RegisterMetricsResponse], error)); ok {
		return rf(ctx, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ...grpc.CallOption) grpc.ClientStreamingClient[RegisterMetricRequest, RegisterMetricsResponse]); ok {
		r0 = rf(ctx, opts...)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockDataRegistryServiceClient_CreateOrUpdateMetrics_Call) Return(_a0 grpc.ClientStreamingClient[RegisterMetricRequest, RegisterMetricsResponse], _a1 error) *MockDataRegistryServiceClient_CreateOrUpdateMetrics_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
func (_m *MockDataRegistryServiceClient) GetMetric(ctx context.Context, in *GetMetricRequest, opts ...grpc.CallOption) (*GetMetricResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *GetMetricRequest, ...grpc.CallOption) (*GetMetricResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *MockDataRegistryServiceClient) RegisterDefinition(ctx context.Context, in *Definition, opts ...grpc.CallOption) (*DefinitionResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *Definition, ...grpc.CallOption) (*DefinitionResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *MockDataRegistryServiceClient) UpdateDefinition(ctx context.Context, in *DefinitionUpdate, opts ...grpc.CallOption) (*DefinitionResponse, error) {
	...
	var r0 *DefinitionResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *DefinitionUpdate, ...grpc.CallOption) (*DefinitionResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *MockDataRegistryServiceClient) UpdateMetric(ctx context.Context, in *UpdateMetricRequest, opts ...grpc.CallOption) (*RegisterMetricResponse, error) {
	...
	var r0 *RegisterMetricResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *UpdateMetricRequest, ...grpc.CallOption) (*RegisterMetricResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
