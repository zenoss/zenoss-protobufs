...
type DataRegistryServiceClient interface {
	...
	CreateOrUpdateMetrics(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[RegisterMetricRequest, RegisterMetricsResponse], error)
...
func (c *dataRegistryServiceClient) CreateOrUpdateMetric(ctx context.Context, in *RegisterMetricRequest, opts ...grpc.CallOption) (*RegisterMetricResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataRegistryService_CreateOrUpdateMetric_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataRegistryServiceClient) CreateOrUpdateMetrics(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[RegisterMetricRequest, RegisterMetricsResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &DataRegistryService_ServiceDesc.Streams[0], DataRegistryService_CreateOrUpdateMetrics_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[RegisterMetricRequest, RegisterMetricsResponse]{ClientStream: stream}
	return x, nil
}
...
func (c *dataRegistryServiceClient) UpdateMetric(ctx context.Context, in *UpdateMetricRequest, opts ...grpc.CallOption) (*RegisterMetricResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterMetricResponse)
	err := c.cc.Invoke(ctx, DataRegistryService_UpdateMetric_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataRegistryServiceClient) RegisterDefinition(ctx context.Context, in *Definition, opts ...grpc.CallOption) (*DefinitionResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataRegistryService_RegisterDefinition_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataRegistryServiceClient) UpdateDefinition(ctx context.Context, in *DefinitionUpdate, opts ...grpc.CallOption) (*DefinitionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DefinitionResponse)
	err := c.cc.Invoke(ctx, DataRegistryService_UpdateDefinition_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataRegistryServiceClient) GetMetric(ctx context.Context, in *GetMetricRequest, opts ...grpc.CallOption) (*GetMetricResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataRegistryService_GetMetric_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DataRegistryServiceServer interface {
	...
	CreateOrUpdateMetrics(grpc.ClientStreamingServer[RegisterMetricRequest, RegisterMetricsResponse]) error
...
func RegisterDataRegistryServiceServer(s grpc.ServiceRegistrar, srv DataRegistryServiceServer) {
	// If the following call pancis, it indicates UnimplementedDataRegistryServiceServer was
...
func _DataRegistryService_CreateOrUpdateMetrics_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DataRegistryServiceServer).CreateOrUpdateMetrics(&grpc.GenericServerStream[RegisterMetricRequest, RegisterMetricsResponse]{ServerStream: stream})
}
