...
type mockConstructorTestingTNewMockDataRegistryService_CreateOrUpdateMetricsClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockDataRegistryService_CreateOrUpdateMetricsClient(t mockConstructorTestingTNewMockDataRegistryService_CreateOrUpdateMetricsClient) *MockDataRegistryService_CreateOrUpdateMetricsClient {
