...
func (_m *MockDataReceiverServiceClient) PutEvent(ctx context.Context, opts ...grpc.CallOption) (DataReceiverService_PutEventClient, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...grpc.CallOption) (DataReceiverService_PutEventClient, error)); ok {
		return rf(ctx, opts...)
	}
...
func (_m *MockDataReceiverServiceClient) PutMetric(ctx context.Context, opts ...grpc.CallOption) (DataReceiverService_PutMetricClient, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...grpc.CallOption) (DataReceiverService_PutMetricClient, error)); ok {
		return rf(ctx, opts...)
	}
