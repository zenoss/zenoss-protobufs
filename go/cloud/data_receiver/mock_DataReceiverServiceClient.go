...
func (_m *MockDataReceiverServiceClient) PutEvent(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[EventWrapper, Void], error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...grpc.CallOption) (grpc.ClientStreamingClient[EventWrapper, Void], error)); ok {
		return rf(ctx, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ...grpc.CallOption) grpc.ClientStreamingClient[EventWrapper, Void]); ok {
		r0 = rf(ctx, opts...)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockDataReceiverServiceClient_PutEvent_Call) Return(_a0 grpc.ClientStreamingClient[EventWrapper, Void], _a1 error) *MockDataReceiverServiceClient_PutEvent_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDataReceiverServiceClient_PutEvent_Call) RunAndReturn(run func(context.Context, ...grpc.CallOption) (grpc.ClientStreamingClient[EventWrapper, Void], error)) *MockDataReceiverServiceClient_PutEvent_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockDataReceiverServiceClient) PutEvents(ctx context.Context, in *Events, opts ...grpc.CallOption) (*EventStatusResult, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *Events, ...grpc.CallOption) (*EventStatusResult, error)); ok {
...
func (_m *MockDataReceiverServiceClient) PutMetric(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[MetricWrapper, Void], error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...grpc.CallOption) (grpc.ClientStreamingClient[MetricWrapper, Void], error)); ok {
		return rf(ctx, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ...grpc.CallOption) grpc.ClientStreamingClient[MetricWrapper, Void]); ok {
		r0 = rf(ctx, opts...)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockDataReceiverServiceClient_PutMetric_Call) Return(_a0 grpc.ClientStreamingClient[MetricWrapper, Void], _a1 error) *MockDataReceiverServiceClient_PutMetric_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDataReceiverServiceClient_PutMetric_Call) RunAndReturn(run func(context.Context, ...grpc.CallOption) (grpc.ClientStreamingClient[MetricWrapper, Void], error)) *MockDataReceiverServiceClient_PutMetric_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockDataReceiverServiceClient) PutMetrics(ctx context.Context, in *Metrics, opts ...grpc.CallOption) (*StatusResult, error) {
	...
	var r0 *StatusResult
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *Metrics, ...grpc.CallOption) (*StatusResult, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *MockDataReceiverServiceClient) PutModels(ctx context.Context, in *Models, opts ...grpc.CallOption) (*ModelStatusResult, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *Models, ...grpc.CallOption) (*ModelStatusResult, error)); ok {
		return rf(ctx, in, opts...)
	}
