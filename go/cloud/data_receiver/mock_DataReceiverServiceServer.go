...
func (_m *MockDataReceiverServiceServer) PutEvent(_a0 grpc.ClientStreamingServer[EventWrapper, Void]) error {
	ret := _m.Called(_a0)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(grpc.ClientStreamingServer[EventWrapper, Void]) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
...
//   - _a0 grpc.ClientStreamingServer[EventWrapper,Void]
...
func (_c *MockDataReceiverServiceServer_PutEvent_Call) Run(run func(_a0 grpc.ClientStreamingServer[EventWrapper, Void])) *MockDataReceiverServiceServer_PutEvent_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(grpc.ClientStreamingServer[EventWrapper, Void]))
	})
	return _c
}
...
func (_c *MockDataReceiverServiceServer_PutEvent_Call) RunAndReturn(run func(grpc.ClientStreamingServer[EventWrapper, Void]) error) *MockDataReceiverServiceServer_PutEvent_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockDataReceiverServiceServer) PutEvents(_a0 context.Context, _a1 *Events) (*EventStatusResult, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *Events) (*EventStatusResult, error)); ok {
		return rf(_a0, _a1)
	}
...
func (_m *MockDataReceiverServiceServer) PutMetric(_a0 grpc.ClientStreamingServer[MetricWrapper, Void]) error {
	ret := _m.Called(_a0)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(grpc.ClientStreamingServer[MetricWrapper, Void]) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
...
//   - _a0 grpc.ClientStreamingServer[MetricWrapper,Void]
...
func (_c *MockDataReceiverServiceServer_PutMetric_Call) Run(run func(_a0 grpc.ClientStreamingServer[MetricWrapper, Void])) *MockDataReceiverServiceServer_PutMetric_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(grpc.ClientStreamingServer[MetricWrapper, Void]))
	})
	return _c
}
...
func (_c *MockDataReceiverServiceServer_PutMetric_Call) RunAndReturn(run func(grpc.ClientStreamingServer[MetricWrapper, Void]) error) *MockDataReceiverServiceServer_PutMetric_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockDataReceiverServiceServer) PutMetrics(_a0 context.Context, _a1 *Metrics) (*StatusResult, error) {
	...
	var r0 *StatusResult
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *Metrics) (*StatusResult, error)); ok {
		return rf(_a0, _a1)
	}
...
func (_m *MockDataReceiverServiceServer) PutModels(_a0 context.Context, _a1 *Models) (*ModelStatusResult, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *Models) (*ModelStatusResult, error)); ok {
		return rf(_a0, _a1)
	}
...
// mustEmbedUnimplementedDataReceiverServiceServer provides a mock function with no fields
