...
// isEventWrapper_EventType provides a mock function with no fields
...
func (_c *mockIsEventWrapper_EventType_isEventWrapper_EventType_Call) RunAndReturn(run func()) *mockIsEventWrapper_EventType_isEventWrapper_EventType_Call {
	_c.Run(run)
	return _c
}
...
func newMockIsEventWrapper_EventType(t interface {
	mock.TestingT
	Cleanup(func())
}) *mockIsEventWrapper_EventType {
