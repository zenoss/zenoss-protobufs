...
// newMockIsEventWrapper_EventType creates a new instance of mockIsEventWrapper_EventType. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func newMockIsEventWrapper_EventType(t testing.TB) *mockIsEventWrapper_EventType {
