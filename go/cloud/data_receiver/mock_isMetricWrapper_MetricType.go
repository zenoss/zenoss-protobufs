...
// isMetricWrapper_MetricType provides a mock function with no fields
...
func (_c *mockIsMetricWrapper_MetricType_isMetricWrapper_MetricType_Call) RunAndReturn(run func()) *mockIsMetricWrapper_MetricType_isMetricWrapper_MetricType_Call {
	_c.Run(run)
	return _c
}
...
func newMockIsMetricWrapper_MetricType(t interface {
	mock.TestingT
	Cleanup(func())
}) *mockIsMetricWrapper_MetricType {
