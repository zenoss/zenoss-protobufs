...
func (c *dataReceiverServiceClient) PutEvents(ctx context.Context, in *Events, opts ...grpc.CallOption) (*EventStatusResult, error) {
	...
	err := c.cc.Invoke(ctx, DataReceiverService_PutEvents_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataReceiverServiceClient) PutEvent(ctx context.Context, opts ...grpc.CallOption) (DataReceiverService_PutEventClient, error) {
	stream, err := c.cc.NewStream(ctx, &DataReceiverService_ServiceDesc.Streams[0], DataReceiverService_PutEvent_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *dataReceiverServiceClient) PutMetrics(ctx context.Context, in *Metrics, opts ...grpc.CallOption) (*StatusResult, error) {
	...
	err := c.cc.Invoke(ctx, DataReceiverService_PutMetrics_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataReceiverServiceClient) PutMetric(ctx context.Context, opts ...grpc.CallOption) (DataReceiverService_PutMetricClient, error) {
	stream, err := c.cc.NewStream(ctx, &DataReceiverService_ServiceDesc.Streams[1], DataReceiverService_PutMetric_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *dataReceiverServiceClient) PutModels(ctx context.Context, in *Models, opts ...grpc.CallOption) (*ModelStatusResult, error) {
	...
	err := c.cc.Invoke(ctx, DataReceiverService_PutModels_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
