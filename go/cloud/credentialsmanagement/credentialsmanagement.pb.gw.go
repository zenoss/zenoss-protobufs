...
/*
Package credentialsmanagement is a reverse proxy.
...
func RegisterCredentialManagementHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CredentialManagementServer) error {
	...
	mux.Handle("GET", pattern_CredentialManagement_GetCredential_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/zenoss.cloud.CredentialManagement/GetCredential", runtime.WithHTTPPathPattern("/v1/credentials/{id}"))
		if err != nil {
...
func RegisterCredentialManagementHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CredentialManagementClient) error {
	...
	mux.Handle("GET", pattern_CredentialManagement_GetCredential_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/zenoss.cloud.CredentialManagement/GetCredential", runtime.WithHTTPPathPattern("/v1/credentials/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
