...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      CompactMetricError.class.getName());
  }
  // Use CompactMetricError.newBuilder() to construct.
  private CompactMetricError(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(org.zenoss.cloud.dataReceiver.CompactMetricError result) {
    ...
    public Builder mergeMetric(org.zenoss.cloud.dataReceiver.CompactMetric value) {
      if (metricBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          metric_ != null &&
          metric_ != org.zenoss.cloud.dataReceiver.CompactMetric.getDefaultInstance()) {
