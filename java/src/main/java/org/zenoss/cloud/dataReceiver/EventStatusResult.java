...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      EventStatusResult.class.getName());
  }
  // Use EventStatusResult.newBuilder() to construct.
  private EventStatusResult(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.zenoss.cloud.dataReceiver.EventStatusResult result) {
      if (failedEventsBuilder_ == null) {
    ...
    private void buildPartial0(org.zenoss.cloud.dataReceiver.EventStatusResult result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              org.zenoss.cloud.dataReceiver.EventError m =
                  input.readMessage(
                      org.zenoss.cloud.dataReceiver.EventError.parser(),
                      extensionRegistry);
              if (failedEventsBuilder_ == null) {
                ensureFailedEventsIsMutable();
                failedEvents_.add(m);
