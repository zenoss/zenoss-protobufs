...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            if (eventTypeCase_ == 1) {
              subBuilder = ((org.zenoss.cloud.dataReceiver.Event) eventType_).toBuilder();
            }
            eventType_ =
                input.readMessage(org.zenoss.cloud.dataReceiver.Event.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((org.zenoss.cloud.dataReceiver.Event) eventType_);
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return org.zenoss.cloud.dataReceiver.DataReceiver.internal_static_zenoss_cloud_EventWrapper_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            org.zenoss.cloud.dataReceiver.EventWrapper.class, org.zenoss.cloud.dataReceiver.EventWrapper.Builder.class);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (eventTypeCase_ == 1) {
      output.writeMessage(1, (org.zenoss.cloud.dataReceiver.Event) eventType_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (eventTypeCase_ == 1) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, (org.zenoss.cloud.dataReceiver.Event) eventType_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof org.zenoss.cloud.dataReceiver.EventWrapper)) {
  ...
  public static org.zenoss.cloud.dataReceiver.EventWrapper parseFrom(
  ...
  public static org.zenoss.cloud.dataReceiver.EventWrapper parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static org.zenoss.cloud.dataReceiver.EventWrapper parseFrom(
  ...
  public static org.zenoss.cloud.dataReceiver.EventWrapper parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static final class Builder extends
      ...
      org.zenoss.cloud.dataReceiver.EventWrapperOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return org.zenoss.cloud.dataReceiver.DataReceiver.internal_static_zenoss_cloud_EventWrapper_descriptor;
    }
    ...
    // Construct using org.zenoss.cloud.dataReceiver.EventWrapper.newBuilder()
    private Builder() {
    ...
    public Builder mergeFrom(org.zenoss.cloud.dataReceiver.EventWrapper other) {
      if (other == org.zenoss.cloud.dataReceiver.EventWrapper.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      org.zenoss.cloud.dataReceiver.EventWrapper parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (org.zenoss.cloud.dataReceiver.EventWrapper) e.getUnfinishedMessage();
    ...
    public Builder mergeCanonical(org.zenoss.cloud.dataReceiver.Event value) {
      if (canonicalBuilder_ == null) {
        if (eventTypeCase_ == 1 &&
          ...
          eventType_ = org.zenoss.cloud.dataReceiver.Event.newBuilder((org.zenoss.cloud.dataReceiver.Event) eventType_)
  ...
  private static final org.zenoss.cloud.dataReceiver.EventWrapper DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new org.zenoss.cloud.dataReceiver.EventWrapper();
  }

  public static org.zenoss.cloud.dataReceiver.EventWrapper getDefaultInstance() {
