...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            org.zenoss.cloud.collection.ProbeSuccess.Builder subBuilder = null;
            if (resultCase_ == 1) {
              subBuilder = ((org.zenoss.cloud.collection.ProbeSuccess) result_).toBuilder();
            }
            result_ =
                input.readMessage(org.zenoss.cloud.collection.ProbeSuccess.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((org.zenoss.cloud.collection.ProbeSuccess) result_);
          ...
          case 18: {
            org.zenoss.cloud.collection.ProbeError.Builder subBuilder = null;
            if (resultCase_ == 2) {
              subBuilder = ((org.zenoss.cloud.collection.ProbeError) result_).toBuilder();
            }
            result_ =
                input.readMessage(org.zenoss.cloud.collection.ProbeError.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((org.zenoss.cloud.collection.ProbeError) result_);
              result_ = subBuilder.buildPartial();
            }
            resultCase_ = 2;
            break;
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      org.zenoss.cloud.collection.ProbeResult parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (org.zenoss.cloud.collection.ProbeResult) e.getUnfinishedMessage();
