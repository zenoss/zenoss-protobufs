...
public final class CredentialManagementGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "zenoss.cloud.credentials.CredentialManagement";
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getCredential(org.zenoss.cloud.credentials.GetCredentialRequest request,
  ...
  /**
   * Base class for the server implementation of the service CredentialManagement.
   */
  public static abstract class CredentialManagementImplBase
      implements io.grpc.BindableService, AsyncService {

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return CredentialManagementGrpc.bindService(this);
    }
  }

  /**
   * A stub to allow clients to do asynchronous rpc calls to service CredentialManagement.
   */
  public static final class CredentialManagementStub
      extends io.grpc.stub.AbstractAsyncStub<CredentialManagementStub> {
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service CredentialManagement.
   */
  public static final class CredentialManagementFutureStub
      extends io.grpc.stub.AbstractFutureStub<CredentialManagementFutureStub> {
  ...
  private static final class CredentialManagementMethodDescriptorSupplier
    ...
    CredentialManagementMethodDescriptorSupplier(java.lang.String methodName) {
