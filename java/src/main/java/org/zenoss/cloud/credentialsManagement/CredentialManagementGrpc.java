...
@javax.annotation.Generated(
    ...
    comments = "Source: zenoss/cloud/credentialsmanagement.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class CredentialManagementGrpc {

  private CredentialManagementGrpc() {}

  public static final String SERVICE_NAME = "zenoss.cloud.CredentialManagement";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<org.zenoss.cloud.credentialsManagement.GetCredentialRequest,
      org.zenoss.cloud.credentialsManagement.GetCredentialResponse> getGetCredentialMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCredential",
      requestType = org.zenoss.cloud.credentialsManagement.GetCredentialRequest.class,
      responseType = org.zenoss.cloud.credentialsManagement.GetCredentialResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.zenoss.cloud.credentialsManagement.GetCredentialRequest,
      org.zenoss.cloud.credentialsManagement.GetCredentialResponse> getGetCredentialMethod() {
    io.grpc.MethodDescriptor<org.zenoss.cloud.credentialsManagement.GetCredentialRequest, org.zenoss.cloud.credentialsManagement.GetCredentialResponse> getGetCredentialMethod;
      ...
      synchronized (CredentialManagementGrpc.class) {
        if ((getGetCredentialMethod = CredentialManagementGrpc.getGetCredentialMethod) == null) {
          CredentialManagementGrpc.getGetCredentialMethod = getGetCredentialMethod =
              io.grpc.MethodDescriptor.<org.zenoss.cloud.credentialsManagement.GetCredentialRequest, org.zenoss.cloud.credentialsManagement.GetCredentialResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCredential"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.zenoss.cloud.credentialsManagement.GetCredentialRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.zenoss.cloud.credentialsManagement.GetCredentialResponse.getDefaultInstance()))
  ...
  public static abstract class CredentialManagementImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getCredential(org.zenoss.cloud.credentialsManagement.GetCredentialRequest request,
        io.grpc.stub.StreamObserver<org.zenoss.cloud.credentialsManagement.GetCredentialResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                org.zenoss.cloud.credentialsManagement.GetCredentialRequest,
                org.zenoss.cloud.credentialsManagement.GetCredentialResponse>(
  ...
  public static final class CredentialManagementBlockingStub extends io.grpc.stub.AbstractBlockingStub<CredentialManagementBlockingStub> {
    ...
    /**
     */
    public org.zenoss.cloud.credentialsManagement.GetCredentialResponse getCredential(org.zenoss.cloud.credentialsManagement.GetCredentialRequest request) {
  ...
  public static final class CredentialManagementFutureStub extends io.grpc.stub.AbstractFutureStub<CredentialManagementFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.zenoss.cloud.credentialsManagement.GetCredentialResponse> getCredential(
        org.zenoss.cloud.credentialsManagement.GetCredentialRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CREDENTIAL:
          serviceImpl.getCredential((org.zenoss.cloud.credentialsManagement.GetCredentialRequest) request,
              (io.grpc.stub.StreamObserver<org.zenoss.cloud.credentialsManagement.GetCredentialResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CredentialManagementBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.zenoss.cloud.credentialsManagement.Credentialsmanagement.getDescriptor();
    }
