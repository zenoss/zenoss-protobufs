...
public final class CollectionConfigServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.zenoss.cloud.collection_cfg.WaitForProbeConfigResponse,
      com.zenoss.cloud.collection_cfg.WaitForProbeConfigRequest> getWaitForProbeConfigMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "WaitForProbeConfig",
      requestType = com.zenoss.cloud.collection_cfg.WaitForProbeConfigResponse.class,
      responseType = com.zenoss.cloud.collection_cfg.WaitForProbeConfigRequest.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.zenoss.cloud.collection_cfg.WaitForProbeConfigResponse,
      com.zenoss.cloud.collection_cfg.WaitForProbeConfigRequest> getWaitForProbeConfigMethod() {
    io.grpc.MethodDescriptor<com.zenoss.cloud.collection_cfg.WaitForProbeConfigResponse, com.zenoss.cloud.collection_cfg.WaitForProbeConfigRequest> getWaitForProbeConfigMethod;
      ...
      synchronized (CollectionConfigServiceGrpc.class) {
        if ((getWaitForProbeConfigMethod = CollectionConfigServiceGrpc.getWaitForProbeConfigMethod) == null) {
          CollectionConfigServiceGrpc.getWaitForProbeConfigMethod = getWaitForProbeConfigMethod =
              io.grpc.MethodDescriptor.<com.zenoss.cloud.collection_cfg.WaitForProbeConfigResponse, com.zenoss.cloud.collection_cfg.WaitForProbeConfigRequest>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "WaitForProbeConfig"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.zenoss.cloud.collection_cfg.WaitForProbeConfigResponse.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.zenoss.cloud.collection_cfg.WaitForProbeConfigRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.zenoss.cloud.collection_cfg.GetConfigStreamRequest,
      com.zenoss.cloud.collection_cfg.GetConfigStreamResponse> getGetConfigStreamMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetConfigStream",
      requestType = com.zenoss.cloud.collection_cfg.GetConfigStreamRequest.class,
      responseType = com.zenoss.cloud.collection_cfg.GetConfigStreamResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.zenoss.cloud.collection_cfg.GetConfigStreamRequest,
      com.zenoss.cloud.collection_cfg.GetConfigStreamResponse> getGetConfigStreamMethod() {
    io.grpc.MethodDescriptor<com.zenoss.cloud.collection_cfg.GetConfigStreamRequest, com.zenoss.cloud.collection_cfg.GetConfigStreamResponse> getGetConfigStreamMethod;
      ...
      synchronized (CollectionConfigServiceGrpc.class) {
        if ((getGetConfigStreamMethod = CollectionConfigServiceGrpc.getGetConfigStreamMethod) == null) {
          CollectionConfigServiceGrpc.getGetConfigStreamMethod = getGetConfigStreamMethod =
              io.grpc.MethodDescriptor.<com.zenoss.cloud.collection_cfg.GetConfigStreamRequest, com.zenoss.cloud.collection_cfg.GetConfigStreamResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetConfigStream"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.zenoss.cloud.collection_cfg.GetConfigStreamRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.zenoss.cloud.collection_cfg.GetConfigStreamResponse.getDefaultInstance()))
  ...
  public static abstract class CollectionConfigServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.zenoss.cloud.collection_cfg.WaitForProbeConfigResponse> waitForProbeConfig(
        io.grpc.stub.StreamObserver<com.zenoss.cloud.collection_cfg.WaitForProbeConfigRequest> responseObserver) {
      return io.grpc.stub.ServerCalls.asyncUnimplementedStreamingCall(getWaitForProbeConfigMethod(), responseObserver);
    }

    /**
     */
    public void getConfigStream(com.zenoss.cloud.collection_cfg.GetConfigStreamRequest request,
        io.grpc.stub.StreamObserver<com.zenoss.cloud.collection_cfg.GetConfigStreamResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                com.zenoss.cloud.collection_cfg.WaitForProbeConfigResponse,
                com.zenoss.cloud.collection_cfg.WaitForProbeConfigRequest>(
                  this, METHODID_WAIT_FOR_PROBE_CONFIG)))
          .addMethod(
            getGetConfigStreamMethod(),
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                com.zenoss.cloud.collection_cfg.GetConfigStreamRequest,
                com.zenoss.cloud.collection_cfg.GetConfigStreamResponse>(
  ...
  public static final class CollectionConfigServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CollectionConfigServiceBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<com.zenoss.cloud.collection_cfg.GetConfigStreamResponse> getConfigStream(
        com.zenoss.cloud.collection_cfg.GetConfigStreamRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CONFIG_STREAM:
          serviceImpl.getConfigStream((com.zenoss.cloud.collection_cfg.GetConfigStreamRequest) request,
              (io.grpc.stub.StreamObserver<com.zenoss.cloud.collection_cfg.GetConfigStreamResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CollectionConfigServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.zenoss.cloud.collection_cfg.CollectionCfgProto.getDescriptor();
    }
