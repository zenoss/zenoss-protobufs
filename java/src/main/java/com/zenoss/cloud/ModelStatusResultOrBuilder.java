...
public interface ModelStatusResultOrBuilder extends
   ...
   */
  java.util.List<com.zenoss.cloud.ModelError> 
      getFailedModelsList();
  /**
   * <pre>
   * Failed models only returned if detailedResponse is set to true
   ...
   * <code>repeated .zenoss.cloud.ModelError failedModels = 4 [json_name = "failedModels"];</code>
   */
  com.zenoss.cloud.ModelError getFailedModels(int index);
  /**
   * <pre>
   * Failed models only returned if detailedResponse is set to true
   * </pre>
   ...
   * <code>repeated .zenoss.cloud.ModelError failedModels = 4 [json_name = "failedModels"];</code>
   */
  java.util.List<? extends com.zenoss.cloud.ModelErrorOrBuilder> 
   ...
   * <code>repeated .zenoss.cloud.ModelError failedModels = 4 [json_name = "failedModels"];</code>
   */
  com.zenoss.cloud.ModelErrorOrBuilder getFailedModelsOrBuilder(
      int index);
}
