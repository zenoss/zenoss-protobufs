...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.zenoss.cloud.DataReceiverProto.internal_static_zenoss_cloud_MetricWrapper_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.zenoss.cloud.DataReceiverProto.internal_static_zenoss_cloud_MetricWrapper_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.zenoss.cloud.MetricWrapper.class, com.zenoss.cloud.MetricWrapper.Builder.class);
  }
   ...
   */
  @java.lang.Override
  public com.zenoss.cloud.TaggedMetric getTagged() {
    if (metricTypeCase_ == 1) {
       return (com.zenoss.cloud.TaggedMetric) metricType_;
    }
    return com.zenoss.cloud.TaggedMetric.getDefaultInstance();
  }
  /**
   * <pre>
   * Verbose format
   ...
   */
  @java.lang.Override
  public com.zenoss.cloud.TaggedMetricOrBuilder getTaggedOrBuilder() {
    if (metricTypeCase_ == 1) {
       return (com.zenoss.cloud.TaggedMetric) metricType_;
    }
    return com.zenoss.cloud.TaggedMetric.getDefaultInstance();
   ...
   */
  @java.lang.Override
  public com.zenoss.cloud.CompactMetric getCompact() {
    if (metricTypeCase_ == 2) {
       return (com.zenoss.cloud.CompactMetric) metricType_;
    }
   ...
   */
  @java.lang.Override
  public com.zenoss.cloud.CompactMetricOrBuilder getCompactOrBuilder() {
    if (metricTypeCase_ == 2) {
       return (com.zenoss.cloud.CompactMetric) metricType_;
    }
    return com.zenoss.cloud.CompactMetric.getDefaultInstance();
   ...
   */
  @java.lang.Override
  public com.zenoss.cloud.Metric getCanonical() {
    if (metricTypeCase_ == 3) {
       return (com.zenoss.cloud.Metric) metricType_;
    }
    return com.zenoss.cloud.Metric.getDefaultInstance();
  }
  /**
   * <pre>
   * Canonical format
   ...
   */
  @java.lang.Override
  public com.zenoss.cloud.MetricOrBuilder getCanonicalOrBuilder() {
    if (metricTypeCase_ == 3) {
       return (com.zenoss.cloud.Metric) metricType_;
    }
    return com.zenoss.cloud.Metric.getDefaultInstance();
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (metricTypeCase_ == 1) {
      output.writeMessage(1, (com.zenoss.cloud.TaggedMetric) metricType_);
    }
    if (metricTypeCase_ == 2) {
      output.writeMessage(2, (com.zenoss.cloud.CompactMetric) metricType_);
    }
    if (metricTypeCase_ == 3) {
      output.writeMessage(3, (com.zenoss.cloud.Metric) metricType_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (metricTypeCase_ == 1) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, (com.zenoss.cloud.TaggedMetric) metricType_);
    }
    if (metricTypeCase_ == 2) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(2, (com.zenoss.cloud.CompactMetric) metricType_);
    }
    if (metricTypeCase_ == 3) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(3, (com.zenoss.cloud.Metric) metricType_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.zenoss.cloud.MetricWrapper)) {
      return super.equals(obj);
    }
    com.zenoss.cloud.MetricWrapper other = (com.zenoss.cloud.MetricWrapper) obj;
  ...
  public static com.zenoss.cloud.MetricWrapper parseFrom(
  ...
  public static com.zenoss.cloud.MetricWrapper parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.zenoss.cloud.MetricWrapper parseFrom(
  ...
  public static com.zenoss.cloud.MetricWrapper parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.zenoss.cloud.MetricWrapper parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static com.zenoss.cloud.MetricWrapper parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.zenoss.cloud.MetricWrapper prototype) {
  ...
  public static final class Builder extends
      ...
      com.zenoss.cloud.MetricWrapperOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.zenoss.cloud.DataReceiverProto.internal_static_zenoss_cloud_MetricWrapper_descriptor;
    }
    ...
    // Construct using com.zenoss.cloud.MetricWrapper.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.zenoss.cloud.MetricWrapper getDefaultInstanceForType() {
      return com.zenoss.cloud.MetricWrapper.getDefaultInstance();
    }

    @java.lang.Override
    public com.zenoss.cloud.MetricWrapper build() {
      com.zenoss.cloud.MetricWrapper result = buildPartial();
    ...
    @java.lang.Override
    public com.zenoss.cloud.MetricWrapper buildPartial() {
      com.zenoss.cloud.MetricWrapper result = new com.zenoss.cloud.MetricWrapper(this);
    ...
    private void buildPartial0(com.zenoss.cloud.MetricWrapper result) {
      int from_bitField0_ = bitField0_;
    }

    private void buildPartialOneofs(com.zenoss.cloud.MetricWrapper result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.zenoss.cloud.MetricWrapper) {
        return mergeFrom((com.zenoss.cloud.MetricWrapper)other);
      } else {
    ...
    public Builder mergeFrom(com.zenoss.cloud.MetricWrapper other) {
      if (other == com.zenoss.cloud.MetricWrapper.getDefaultInstance()) return this;
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.zenoss.cloud.TaggedMetric, com.zenoss.cloud.TaggedMetric.Builder, com.zenoss.cloud.TaggedMetricOrBuilder> taggedBuilder_;
    /**
     * <pre>
     * Verbose format
     * </pre>
     ...
     * <code>.zenoss.cloud.TaggedMetric tagged = 1 [json_name = "tagged"];</code>
     */
    public Builder setTagged(com.zenoss.cloud.TaggedMetric value) {
      if (taggedBuilder_ == null) {
        if (value == null) {
     ...
     * <code>.zenoss.cloud.TaggedMetric tagged = 1 [json_name = "tagged"];</code>
     */
    public Builder mergeTagged(com.zenoss.cloud.TaggedMetric value) {
      if (taggedBuilder_ == null) {
        if (metricTypeCase_ == 1 &&
            metricType_ != com.zenoss.cloud.TaggedMetric.getDefaultInstance()) {
          metricType_ = com.zenoss.cloud.TaggedMetric.newBuilder((com.zenoss.cloud.TaggedMetric) metricType_)
     ...
     * <code>.zenoss.cloud.TaggedMetric tagged = 1 [json_name = "tagged"];</code>
     */
    public com.zenoss.cloud.TaggedMetric.Builder getTaggedBuilder() {
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
      ...
      if (taggedBuilder_ == null) {
        ...
        taggedBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.zenoss.cloud.TaggedMetric, com.zenoss.cloud.TaggedMetric.Builder, com.zenoss.cloud.TaggedMetricOrBuilder>(
                (com.zenoss.cloud.TaggedMetric) metricType_,
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.zenoss.cloud.CompactMetric, com.zenoss.cloud.CompactMetric.Builder, com.zenoss.cloud.CompactMetricOrBuilder> compactBuilder_;
    /**
     * <pre>
     * Compact format
     * </pre>
     ...
     * <code>.zenoss.cloud.CompactMetric compact = 2 [json_name = "compact"];</code>
     */
    public Builder setCompact(com.zenoss.cloud.CompactMetric value) {
      if (compactBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>.zenoss.cloud.CompactMetric compact = 2 [json_name = "compact"];</code>
     */
    public Builder mergeCompact(com.zenoss.cloud.CompactMetric value) {
      if (compactBuilder_ == null) {
        if (metricTypeCase_ == 2 &&
            metricType_ != com.zenoss.cloud.CompactMetric.getDefaultInstance()) {
          metricType_ = com.zenoss.cloud.CompactMetric.newBuilder((com.zenoss.cloud.CompactMetric) metricType_)
              .mergeFrom(value).buildPartial();
        } else {
          metricType_ = value;
        }
     ...
     * <code>.zenoss.cloud.CompactMetric compact = 2 [json_name = "compact"];</code>
     */
    public com.zenoss.cloud.CompactMetric.Builder getCompactBuilder() {
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
      ...
      if (compactBuilder_ == null) {
        ...
        compactBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.zenoss.cloud.CompactMetric, com.zenoss.cloud.CompactMetric.Builder, com.zenoss.cloud.CompactMetricOrBuilder>(
                (com.zenoss.cloud.CompactMetric) metricType_,
                getParentForChildren(),
                isClean());
        metricType_ = null;
      }
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.zenoss.cloud.Metric, com.zenoss.cloud.Metric.Builder, com.zenoss.cloud.MetricOrBuilder> canonicalBuilder_;
    /**
     * <pre>
     * Canonical format
     * </pre>
     ...
     * <code>.zenoss.cloud.Metric canonical = 3 [json_name = "canonical"];</code>
     */
    public Builder setCanonical(com.zenoss.cloud.Metric value) {
      if (canonicalBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>.zenoss.cloud.Metric canonical = 3 [json_name = "canonical"];</code>
     */
    public Builder mergeCanonical(com.zenoss.cloud.Metric value) {
      if (canonicalBuilder_ == null) {
        if (metricTypeCase_ == 3 &&
            metricType_ != com.zenoss.cloud.Metric.getDefaultInstance()) {
          metricType_ = com.zenoss.cloud.Metric.newBuilder((com.zenoss.cloud.Metric) metricType_)
              .mergeFrom(value).buildPartial();
        } else {
          metricType_ = value;
        }
     ...
     * <code>.zenoss.cloud.Metric canonical = 3 [json_name = "canonical"];</code>
     */
    public com.zenoss.cloud.Metric.Builder getCanonicalBuilder() {
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
      ...
      if (canonicalBuilder_ == null) {
        ...
        canonicalBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.zenoss.cloud.Metric, com.zenoss.cloud.Metric.Builder, com.zenoss.cloud.MetricOrBuilder>(
                (com.zenoss.cloud.Metric) metricType_,
                getParentForChildren(),
                isClean());
        metricType_ = null;
      }
  ...
  private static final com.zenoss.cloud.MetricWrapper DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.zenoss.cloud.MetricWrapper();
  }

  public static com.zenoss.cloud.MetricWrapper getDefaultInstance() {
