...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.zenoss.cloud.DataReceiverProto.internal_static_zenoss_cloud_Models_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.zenoss.cloud.DataReceiverProto.internal_static_zenoss_cloud_Models_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.zenoss.cloud.Models.class, com.zenoss.cloud.Models.Builder.class);
  }
  ...
  private java.util.List<com.zenoss.cloud.Model> models_;
  /**
   * <pre>
   * The models
   * </pre>
   ...
   */
  @java.lang.Override
  public java.util.List<com.zenoss.cloud.Model> getModelsList() {
    return models_;
  }
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<? extends com.zenoss.cloud.ModelOrBuilder> 
   ...
   */
  @java.lang.Override
  public com.zenoss.cloud.Model getModels(int index) {
   ...
   */
  @java.lang.Override
  public com.zenoss.cloud.ModelOrBuilder getModelsOrBuilder(
      int index) {
    return models_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.zenoss.cloud.Models)) {
      return super.equals(obj);
    }
    com.zenoss.cloud.Models other = (com.zenoss.cloud.Models) obj;
  ...
  public static com.zenoss.cloud.Models parseFrom(
  ...
  public static com.zenoss.cloud.Models parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.zenoss.cloud.Models parseFrom(
  ...
  public static com.zenoss.cloud.Models parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.zenoss.cloud.Models parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static com.zenoss.cloud.Models parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.zenoss.cloud.Models prototype) {
  ...
  public static final class Builder extends
      ...
      com.zenoss.cloud.ModelsOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.zenoss.cloud.DataReceiverProto.internal_static_zenoss_cloud_Models_descriptor;
    }
    ...
    // Construct using com.zenoss.cloud.Models.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.zenoss.cloud.Models getDefaultInstanceForType() {
      return com.zenoss.cloud.Models.getDefaultInstance();
    }

    @java.lang.Override
    public com.zenoss.cloud.Models build() {
      com.zenoss.cloud.Models result = buildPartial();
    ...
    @java.lang.Override
    public com.zenoss.cloud.Models buildPartial() {
      com.zenoss.cloud.Models result = new com.zenoss.cloud.Models(this);
    ...
    private void buildPartialRepeatedFields(com.zenoss.cloud.Models result) {
      if (modelsBuilder_ == null) {
    ...
    private void buildPartial0(com.zenoss.cloud.Models result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.zenoss.cloud.Models) {
        return mergeFrom((com.zenoss.cloud.Models)other);
      } else {
    ...
    public Builder mergeFrom(com.zenoss.cloud.Models other) {
      if (other == com.zenoss.cloud.Models.getDefaultInstance()) return this;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              com.zenoss.cloud.Model m =
                  input.readMessage(
                      com.zenoss.cloud.Model.parser(),
                      extensionRegistry);
              if (modelsBuilder_ == null) {
                ensureModelsIsMutable();
                models_.add(m);
    ...
    private void ensureModelsIsMutable() {
      if (!((bitField0_ & 0x00000002) != 0)) {
        models_ = new java.util.ArrayList<com.zenoss.cloud.Model>(models_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.zenoss.cloud.Model, com.zenoss.cloud.Model.Builder, com.zenoss.cloud.ModelOrBuilder> modelsBuilder_;
    ...
    public Builder setModels(
        int index, com.zenoss.cloud.Model value) {
      if (modelsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setModels(
        int index, com.zenoss.cloud.Model.Builder builderForValue) {
      if (modelsBuilder_ == null) {
        ensureModelsIsMutable();
     ...
     * <code>repeated .zenoss.cloud.Model models = 2 [json_name = "models"];</code>
     */
    public Builder addModels(com.zenoss.cloud.Model value) {
      if (modelsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllModels(
        java.lang.Iterable<? extends com.zenoss.cloud.Model> values) {
      if (modelsBuilder_ == null) {
        ensureModelsIsMutable();
     ...
     * <code>repeated .zenoss.cloud.Model models = 2 [json_name = "models"];</code>
     */
    public com.zenoss.cloud.Model.Builder getModelsBuilder(
        int index) {
     ...
     * <code>repeated .zenoss.cloud.Model models = 2 [json_name = "models"];</code>
     */
    public com.zenoss.cloud.Model.Builder addModelsBuilder() {
      return getModelsFieldBuilder().addBuilder(
          com.zenoss.cloud.Model.getDefaultInstance());
    }
    /**
     * <pre>
     * The models
    ...
    public com.zenoss.cloud.Model.Builder addModelsBuilder(
        int index) {
      return getModelsFieldBuilder().addBuilder(
          index, com.zenoss.cloud.Model.getDefaultInstance());
    }
    /**
     * <pre>
     * The models
     ...
     * <code>repeated .zenoss.cloud.Model models = 2 [json_name = "models"];</code>
     */
    public java.util.List<com.zenoss.cloud.Model.Builder> 
  ...
  private static final com.zenoss.cloud.Models DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.zenoss.cloud.Models();
  }

  public static com.zenoss.cloud.Models getDefaultInstance() {
