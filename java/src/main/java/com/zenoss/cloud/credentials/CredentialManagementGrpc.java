...
public final class CredentialManagementGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.zenoss.cloud.credentials.GetCredentialRequest,
      com.zenoss.cloud.credentials.GetCredentialResponse> getGetCredentialMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCredential",
      requestType = com.zenoss.cloud.credentials.GetCredentialRequest.class,
      responseType = com.zenoss.cloud.credentials.GetCredentialResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.zenoss.cloud.credentials.GetCredentialRequest,
      com.zenoss.cloud.credentials.GetCredentialResponse> getGetCredentialMethod() {
    io.grpc.MethodDescriptor<com.zenoss.cloud.credentials.GetCredentialRequest, com.zenoss.cloud.credentials.GetCredentialResponse> getGetCredentialMethod;
      ...
      synchronized (CredentialManagementGrpc.class) {
        if ((getGetCredentialMethod = CredentialManagementGrpc.getGetCredentialMethod) == null) {
          CredentialManagementGrpc.getGetCredentialMethod = getGetCredentialMethod =
              io.grpc.MethodDescriptor.<com.zenoss.cloud.credentials.GetCredentialRequest, com.zenoss.cloud.credentials.GetCredentialResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCredential"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.zenoss.cloud.credentials.GetCredentialRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.zenoss.cloud.credentials.GetCredentialResponse.getDefaultInstance()))
  ...
  public static abstract class CredentialManagementImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getCredential(com.zenoss.cloud.credentials.GetCredentialRequest request,
        io.grpc.stub.StreamObserver<com.zenoss.cloud.credentials.GetCredentialResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.zenoss.cloud.credentials.GetCredentialRequest,
                com.zenoss.cloud.credentials.GetCredentialResponse>(
  ...
  public static final class CredentialManagementBlockingStub extends io.grpc.stub.AbstractBlockingStub<CredentialManagementBlockingStub> {
    ...
    /**
     */
    public com.zenoss.cloud.credentials.GetCredentialResponse getCredential(com.zenoss.cloud.credentials.GetCredentialRequest request) {
  ...
  public static final class CredentialManagementFutureStub extends io.grpc.stub.AbstractFutureStub<CredentialManagementFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.zenoss.cloud.credentials.GetCredentialResponse> getCredential(
        com.zenoss.cloud.credentials.GetCredentialRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CREDENTIAL:
          serviceImpl.getCredential((com.zenoss.cloud.credentials.GetCredentialRequest) request,
              (io.grpc.stub.StreamObserver<com.zenoss.cloud.credentials.GetCredentialResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CredentialManagementBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.zenoss.cloud.credentials.CredentialsProto.getDescriptor();
    }
